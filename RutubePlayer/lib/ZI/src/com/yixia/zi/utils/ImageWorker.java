...
public abstract class ImageWorker {
	 ...
	 * {@link com.yixia.zi.utils.ImageWorker#processBitmap(Object)} to define the processing logic).
	 * A memory and disk cache will be used if an {@link ImageCache} has been set
	 * using {@link com.yixia.zi.utils.ImageWorker#setImageCache(ImageCache)}. If the image is found
	...
	/**
	 * Executes the given {@link com.yixia.zi.utils.ImageWorker.BitmapWorkerTask} in parallel. On Honeycomb the
	 ...
	 * {@link com.yixia.zi.utils.ImageWorker#loadImage(Object, android.widget.ImageView)}
